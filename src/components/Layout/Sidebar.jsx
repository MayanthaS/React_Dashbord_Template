    ...
    <div className="transition duration-300 ease-in-out bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl border-r border-slate-200/50 dark:border-slate-700/50 flex flex-col relative z-10">
        ...
        <div className="p-6 border-b border-slate-200/50 dark:border-slate-700/50">
         <div className='flex items-center space-x-3'>
            ...
            <div >
                <h1 className='text-xl font-bold text-slate-800 dark:text-white'>Simple</h1>
                <p className='text-xs text-slate-300 dark:text-slate-400'>Admin panel</p>
            </div>
         </div>
        </div>
        {/*navigationbar*/}
       ...
       <div className='p-4 border-t border-slate-200/50 drak:border-slate-700/50' >
        <div className='flex items-center space-x-3 p-3 rounded-xl bg-slate-50 dark:bg-slate-800/50'>
         <img src='./src/images/img.png' alt='user' className='w-10 h-10 rounded-full ring-2 ring-blue-500 '/>
         <div className='flex-1 min-w-0'>
            <p className='text-sm font-medium text-slate-800 dark:text-white truncate'>Mayantha Sapumal</p>
